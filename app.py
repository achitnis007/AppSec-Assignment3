...
# user = User(username='tester1', phone='1111111111', password=hashed_password)
# db.session.add(user)
#
# hashed_password = bcrypt.generate_password_hash('2222222222').decode('utf-8')
# user = User(username='tester2', phone='2222222222', password=hashed_password)
# db.session.add(user)
#
# hashed_password = bcrypt.generate_password_hash('3333333333').decode('utf-8')
# user = User(username='tester3', phone='3333333333', password=hashed_password)
# db.session.add(user)
